...
export class Backend implements backendInterface {
    ...
    async getAllProfiles(): Promise<Array<PlayerProfile>> {
    ...
    async getClues(arg0: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getClues(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPlayerStats(arg0: string): Promise<[bigint, bigint]> {
        if (this.processError) {
            try {
    ...
    async getProfile(arg0: string): Promise<PlayerProfile> {
        if (this.processError) {
            try {
    ...
    async saveProfile(arg0: string, arg1: bigint, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
